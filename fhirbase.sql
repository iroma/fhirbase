      ...
      $$;
      insert into plv8_modules values ('medapp', true, E'// Generated by CoffeeScript 1.5.0
(function() {
  var log, self;
  ...
  this.sql = {
    ...
    resources: function(version) {
      return plv8.execute("select * from meta.resources");
    },
    generate_schema: function(version) {
      return log(self.sql.resources());
    },
